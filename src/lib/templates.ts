  ...
  days: [
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'incline_db_curl', name: 'Incline DB Curl', category: 'acc', sets: 3, reps: 12, defaultWeight: 20, note: 'Bench at 45-60 deg. Let the arms hang dead behind you - do not swing them forward.' },
        { id: 'preacher_curl', name: 'Preacher Curl', category: 'acc', sets: 3, reps: 12, defaultWeight: 50, note: 'Full stretch at the bottom, controlled. EZ bar or machine.' },
